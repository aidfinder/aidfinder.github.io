<ul class="nav">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user" style="font-size:13pt"></i>&nbsp;&nbsp;&nbsp;<span style="font-size:11pt"class="text"><?php echo $_SESSION['architectlogged']['b_lname'].'&nbsp;, '.$_SESSION['architectlogged']['b_fname'].'&nbsp;'.$_SESSION['architectlogged']['b_mname']; ?></span><b class="caret"></b></a>
