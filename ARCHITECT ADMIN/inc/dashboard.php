...
<!--Chart-box-->    
    <div class="row-fluid">
      <div class="widget-box">
        <?php $querying = $model->getCountlog();  $counting=0;
              if( $resulting = $model->fetch($querying) ){$counting=$resulting['count(log_id)'];} 
                if($counting==1){
              ?>
            ...
            <div class="widget-content" >
              <div class="row-fluid">
                <div class="span9">
                  ...
                  <input name="filename" id="filename" value="<?php echo $_SESSION['architectlogged']['builder_id']; ?>" type="hidden" />
        ...
        <?php }else{ ?>
          ...
          <div class="widget-content" >
            <div class="row-fluid">
              ...
              <div class="span3">
                <ul class="site-stats">
                  <li class="bg_lh"><i class="icon-user"></i> <strong>2540</strong> <small>Pending Request</small></li>
                  <li class="bg_lh"><i class="icon-plus"></i> <strong>120</strong> <small>Approved Request</small></li>
                  <li class="bg_lh"><i class="icon-plus"></i> <strong>120</strong> <small>Reviews</small></li>
                  <li class="bg_lh"><i class="icon-tag"></i> <strong>9540</strong> <small>Catered Request</small></li>
    ...
    <!--div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="index.html"> <i class="icon-dashboard"></i> <span class="label label-important">20</span> Pending Requests </a> </li>
        <li class="bg_lg span3"> <a href="charts.html"> <i class="icon-signal"></i> Approved Requests</a> </li>
        <li class="bg_ly"> <a href="widgets.html"> <i class="icon-inbox"></i><span class="label label-success">101</span> Reviews </a> </li>
        <li class="bg_lo"> <a href="admin.php?page=viewAccomProj"> <i class="icon-th"></i> Accomplished Project(s)<span class="label label-success"><?php echo $model->total_accomplished_count(); ?></span></a></li>
        <li class="bg_ls"> <a href="grid.html"> <i class="icon-fullscreen"></i> Catered Request</a> </li>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title bg_ly" data-toggle="collapse" href="#collapseG2"><span class="icon"><i class="icon-chevron-down"></i></span>
            <h5 style="font-size:11pt;font-family: Century Gothic">Services</h5>
          ...
          <div class="widget-content nopadding collapse in" id="collapseG2">
            <ul class="recent-posts">
              <?php
                $count=0;
                $query = $model->all_myservice_dashboard();  //FROM MODEL
              ...
              <b><li>
                ...
                <div class="article-post"> <span class="user-info" style="font-size:11pt;font-family: Century Gothic"><?php echo number_format($result['cost']); ?></span>
                  <p><a href="#" style="font-size:11pt;font-family: Century Gothic"><?php echo $result['service_type']; ?></a> </p>
                </div>
              
              <?php }while($result = $model->fetch($query)); }?>
              <li>
                <a href="admin.php?page=viewMyService"><button class="btn btn-info btn-mini">View All</button></a>
              </li></b>
            </ul>
          </div>
        </div>
