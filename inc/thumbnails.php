...
<body style="background-color: #ffffff; font-family: Arial, Verdana, Sans-Serif;">
    ...
    <div id="slider1_container1" style="position: relative; width: 600px;
        height: 300px;">
        ...
        <!-- Slides Container -->
        <div u="slides" style="position: absolute; left: 0px; top: 0px; width: 600px; height: 300px;box-shadow:2px 2px 5px gray;
            overflow: hidden;">
            <?php
            ...
            ?> 
                <div>
                    ...
                    <div u="thumb" >
                        <?php echo $result['design_title']; ?> | Php <?php echo $result['design_cost']; ?> 
                    </div>
                </div>
            <?php 
