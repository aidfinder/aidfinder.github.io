...
<!-- events-top -->
	<div class="services">
	   <div class="container">	
	     	<h3 class="tittle_agile_w3">INTERIOR DESIGNERS</h3>
			...
			<ul class="portfolio_agile_info_w3ls">	
			        ...
			        $query = $model->__list_Architect_count('Interior Designer');  //FROM MODEL
			        ...
			        $query = $model->__list_Architect_limit($startArticle,6,'Interior Designer');  //FROM MODEL
			        if( $result = $model->fetch($query) ){
			        do{
			        $count++;
			        ?> 
					...
					<div class="agile_events_top_grid">
						...
						<?php }else{ ?>	
							<a href="#" data-toggle="modal" data-target="#myModalInterior<?php echo $result['builder_id']; ?>">
						<?php } ?>
