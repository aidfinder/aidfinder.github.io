<!DOCTYPE html>
            ...
            <body style="padding: 0; margin: 0; font-family:Arial, Verdana;background-color:#fff;">
                ...
                <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 800px;box-shadow:2px 2px 5px gray;
                    ...
                    <div u="loading" style="position: absolute; top: 0px; left: 0px;">
                        ...
                        <div style="position: absolute; display: block; background: url(pictures/bx_loader.gif) no-repeat center center;
                            top: 0px; left: 0px;width: 100%;height:100%;">
                        </div>
                    </div>

                    <!-- Slides Container -->
                    <div u="slides" style="position: absolute; left: 0px; top: 0px; width: 800px; height: 356px; overflow: hidden;">
                        <?php
                        $query = $model->specific_interiorAccomplished($_GET['arch_thumbnail']);  //FROM MODEL
                        if( $result = $model->fetch($query) ){
                            do{
                        ?> 
                            <div>
                                <img u="image" src="INTERIOR ADMIN/interior_accomplished_img/<?php echo $result['ID_accomp_id']; ?>.jpg" />
                                <img u="thumb" src="INTERIOR ADMIN/interior_accomplished_img/<?php echo $result['ID_accomp_id']; ?>.jpg" />
                            </div>
                        <?php 
