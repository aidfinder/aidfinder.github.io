<div class="agile_inner_banner_info">
  <h2>Pick Your Location to Find Interior Designer </h2>
  <a href="javascript:;" onclick="startCalculation()" class="view resw3"><i class="fa fa-search"><label style="font-family:Century Gothic;font-size;15pt;">&nbsp;&nbsp;&nbsp;&nbsp;F I N D&nbsp;&nbsp;&nbsp;&nbsp;N O W</label></i></a>
   <?php if(isset($_GET['interior_lat'])){ ?>
   <a style="font-size:11pt" href="index.php?page=viewOnMapInterior" class="view resw3"><b><i class="fa fa-location-arrow"></i>&nbsp;&nbsp;&nbsp;&nbsp;VIEW on MAP</b></a>
    <?php }else{ ?>
    <?php } ?>
    <br/>
...
<div class="services">
    <?php if(isset($_GET['interior_lat'])){ ?>
                  <?php 
                    $fafang=$_GET['interior_lat'];$mamang=$_GET['interior_long'];
                    $querysv = $model->deletedumm();

                    $querk = $model->__list_InteriorDesigner();
                    ...
                    $querkd = $model->listDummy_Interior();
    ...
    <div class="container">
      ...
      <div class="w3_services_grids">
              ...
              <?php }else{ ?>
                <a class="view resw3" href="index.php?page=interior_page&interior=<?php echo $quer2ks['builder_id']; ?>" >Read More</a>
              <?php } ?></li>
                ...
                <p style="font-size:10pt;"><b>
                    <?php $querying = $model->getExpertise($quer2ks['expertise_id']);  
                      if( $resulting = $model->fetch($querying) ){echo $resulting['expertise'];}  ?>
                </b></p>
                <p><i class="fa fa-home"> </i>&nbsp;&nbsp; Design Samples : 
                  <?php 
                    $queryq = $model->count_interior_accomplished($quer2ks['builder_id']);  
  ...
  <script>
    ...
    function startCalculation(){
      ...
      document.location.href="index.php?page=findInterior&interior_lat="+lati+"&interior_long="+longi
    }
