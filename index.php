...
<link rel="stylesheet" href="https://maxdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">
...
<?php if(isset($_SESSION['userlogged'])){
	$querysing = $model->count_notif();$countsing=0;
	if($resultsing = $model->fetch($querysing)){$countsing=$resultsing['count(b.bid_id)'];}
...
<div class="agileits_top_menu">
   <div class="w3l_header_left">
		<ul>
			...
			<!--li class="dropdown">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" onclick="myFunction(<?php echo $_SESSION['userlogged']['user_id']; ?>)">
			...
			<li><a href="#"  onclick="myFunction(<?php echo $_SESSION['userlogged']['user_id']; ?>)">
				<span class="label label-pill label-danger count"><?php if($countsing>0) { echo $countsing; } ?></span>
				Notification
			</a></li>
		</ul>
	</div>
...
<script type="text/javascript">
	function myFunction(a) {
		document.location.href="index.php?page=architecture&myprojects&user_id="+a
	}
</script>
</body>
</html>