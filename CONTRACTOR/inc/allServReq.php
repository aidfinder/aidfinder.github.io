                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                          <li><a href="admin.php?page=allServReq&allApproveReq_userID=<?php echo $resulta['user_id']; ?>&approveReq_dateReq=<?php echo $resulta['date_requested']; ?>">Approve</a></li>
