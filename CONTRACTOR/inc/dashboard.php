...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <ul class="quick-actions">
          ...
          <li> <a href="" data-toggle="modal" data-target="#update"> <i class="icon-people"></i> My Account </a> </li>
          <li> <a href="#"> <i class="icon-web"></i> View Client's Project</a> </li>
          <li> <a href="#"> <i class="icon-calendar"></i> View Bidding Status </a> </li>
