<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="" style="font-size:20pt;font-family: Century Gothic" title="Welcome !" class="tip-right"><i class="icon-home"></i> INTERIOR DESIGNER PAGE</a></div>
  </div>
<!--End-breadcrumbs-->
    ...
    <div class="row-fluid">
      <div class="widget-box">
        <div class="widget-title bg_lg"><span class="icon"><i class="icon-signal"></i></span>
          <h5>Interior Accomplished Design</h5>
        </div>
