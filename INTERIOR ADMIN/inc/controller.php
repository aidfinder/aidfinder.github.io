...
class Controller{
	...
	public function __construct(){
        ...
        {
                mysql_query("update tbl_logs set logout_date = NOW(), logout_time = CURTIME(), logs_status=0 where logs_status=1 and logger_type='Interior Designer' and logger_id='".$_SESSION['interiorlogged']['builder_id']."'")or die(mysql_error());
                 if(session_destroy()){
