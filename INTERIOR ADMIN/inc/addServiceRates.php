      ...
      <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
        ...
        <div class="widget-content">
            <div class="control-group">
              <label class="control-label">Tier Cost *</label>
              <div class="controls">
                  <input type="text" placeholder="Input Your Rate" name="service_cost_rangefrom" class="span12" onkeypress="return isNumber(event)" required>
              </div>
            </div>
            <!--div class="control-group">
