                    ...
                    <div class="panel-body">
                        <div class="col-md-8">
                            <form method="post" role="form">
                                <h3><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Add Form [ Expertise ]</h3>
                                <br/><br/>
                                
                                <div class="form-group">
                                  <label>Expertise</label>&nbsp;&nbsp;<span style="color:red"> *</span>
                                  <br/>
                                  <textarea style="height:40px" name="expertise"type="text" class="form-control" required></textarea>
                                </div>
                                  <div class="form-group">
                                  <label>Details</label>&nbsp;&nbsp;<span style="color:red"> *</span>
                                  <br/>
                                  <textarea style="height:150px" name="ex_dec"type="text" class="form-control" required></textarea>
                                </div>
                                ...
                                <button name="addExpertise"type="submit" class="btn btn-success">&nbsp;&nbsp;Submit&nbsp;&nbsp;</button>
