            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">List of Specialization</span>
                                ...
                                <div class="card-body">
                                    <table class="datatable table table-striped" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $count=0;
                                            $query = $model->all_specialization();  //FROM MODEL
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="btn-group">
                                                        <?php if($result['specialization_status']==1){ ?>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                              <li> <a href="admin.php?page=listSpecialization&deactSpecialization=<?php echo $result['specialization_id']; ?>">Deactivate</a>
                                                              </li>
                                                              <li><a href="admin.php?page=editSpecialization&ide=<?php echo $result['specialization_id']; ?>">Edit</a>
                                                              </li>
                                                        ...
                                                        <?php }else{ ?>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                              ...
                                                              <li> <a href="admin.php?page=listSpecialization&actSpecialization=<?php echo $result['specialization_id']; ?>">Activate</a>
                                                              <li><a href="admin.php?page=editSpecialization&ide=<?php echo $result['specialization_id']; ?>">Edit</a>
                                                              </li>
                                                              <!--li><a href="" data-toggle="modal" data-target="#myMake">Add Make</a>
                                                              </li-->
