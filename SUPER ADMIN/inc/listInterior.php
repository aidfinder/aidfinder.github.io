            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">List of Interior Designer</span>
                                ...
                                <div class="card-body">
                                    <table class="datatable table table-striped" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $count=0;
                                            $query = $model->all_builderInterior();  //FROM MODEL
                                                    ...
                                                    <div class="btn-group">
                                                        <?php if($result['b_status']==1){ ?>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                              <li><a href="admin.php?page=listInterior&deactInterior=<?php echo $result['builder_id']; ?>">Deactivate</a>
                                                              </li>
                                                              <li><a href="admin.php?page=editInterior&ide=<?php echo $result['builder_id']; ?>">Edit</a>
                                                              </li>
                                                        ...
                                                        <?php }else{ ?>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                              ...
                                                              <li><a href="admin.php?page=listInterior&actInterior=<?php echo $result['builder_id']; ?>">Activate</a>
                                                              </li>
                                                              <li><a href="admin.php?page=editInterior&ide=<?php echo $result['builder_id']; ?>">Edit</a>
                                                              </li>
                                                              <!--li><a href="" data-toggle="modal" data-target="#myMake">Add Make</a>
