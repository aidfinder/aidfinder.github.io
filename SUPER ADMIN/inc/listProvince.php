            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">List of Province</span>
                                                    ...
                                                    <div class="btn-group">
                                                        <?php if($result['prov_status']==1){ ?>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                              <li> <a href="admin.php?page=listProvince&deactProvince=<?php echo $result['prov_id']; ?>">Deactivate</a>
                                                              </li>
                                                              <li><a href="admin.php?page=editProvince&id=<?php echo $result['prov_id']; ?>">Edit</a>
                                                              </li>
                                                        ...
                                                        <?php }else{ ?>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                              ...
                                                              <li> <a href="admin.php?page=listProvince&actProvince=<?php echo $result['prov_id']; ?>">Activate</a>
                                                              <li><a href="admin.php?page=editProvince&id=<?php echo $result['prov_id']; ?>">Edit</a>
                                                              </li>
                                                              <!--li><a href="" data-toggle="modal" data-target="#myMake">Add Make</a>
                                                              </li-->
