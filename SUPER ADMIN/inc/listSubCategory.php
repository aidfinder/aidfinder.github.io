            ...
            <div class="container-fluid">
                <div class="side-body">
                    <div class="page-title">
                        <span class="title">List of Sub Category</span>
                                ...
                                <div class="card-body">
                                    <table class="datatable table table-striped" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $count=0;
                                            $query = $model->list_subcategory();  //FROM MODEL
                                                    ...
                                                    <div class="btn-group">
                                                        <?php if($result['subcat_status']==1){ ?>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                              <li><a href="admin.php?page=listSubCategory&deactSubCategory=<?php echo $result['subcat_id']; ?>">Deactivate</a>
                                                              </li>
                                                              <li><a href="admin.php?page=editSubCategory&ide=<?php echo $result['subcat_id']; ?>">Edit</a>
                                                              </li>
                                                        ...
                                                        <?php }else{ ?>
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                              ...
                                                              <li><a href="admin.php?page=listSubCategory&actSubCategory=<?php echo $result['subcat_id']; ?>">Activate</a>
                                                              </li>
                                                              <li><a href="admin.php?page=editSubCategory&ide=<?php echo $result['subcat_id']; ?>">Edit</a>
                                                              </li>
                                                              <!--li><a href="" data-toggle="modal" data-target="#myMake">Add Make</a>
