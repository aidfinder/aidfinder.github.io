                    ...
                    <div class="panel-body">
                        <div class="col-md-8">
                            <form method="post" role="form">
                                <h3><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Add Form [ Province ]</h3>
                                <br/><br/>
                                  ...
                                  <br/>
                                  <textarea style="height:50px" name="name"type="text" class="form-control" required></textarea>
                                </div>
                                ...
                                <button name="addProvince"type="submit" class="btn btn-success">&nbsp;&nbsp;Submit&nbsp;&nbsp;</button>
