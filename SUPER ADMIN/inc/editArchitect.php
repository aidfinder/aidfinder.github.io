					...
					<div class="panel-body">
						<div class="col-md-7">
							<form role="form" method="post">
								...
								<h3>Update Architect Information&nbsp;&nbsp;<span style="color:red"> *</span></h3>
								<br/>
								<?php
                                $count=0;
                                $query = $model->all_listArchitect();  //FROM MODEL
								...
								<button name="editArchitect"type="submit" class="btn btn-success">&nbsp;&nbsp;Save Changes&nbsp;&nbsp;</button>
